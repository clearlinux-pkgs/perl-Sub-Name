...
%prep
%setup -q -n Sub-Name-0.28
cd %{_builddir}/Sub-Name-0.28
pushd ..
cp -a Sub-Name-0.28 buildavx2
popd
...
cp %{_builddir}/Sub-Name-%{version}/LICENCE %{buildroot}/usr/share/package-licenses/perl-Sub-Name/bf1369ac83093a813bff0a90028cd62e3b675470 || :
if test -f Makefile.PL; then
...
/usr/share/package-licenses/perl-Sub-Name/bf1369ac83093a813bff0a90028cd62e3b675470
